module ActiveAdmin
  ...
  class FilterFormBuilder < FormBuilder
    ...
    def column_for(method)
      @object.base.columns_hash[method.to_s] if @object && @object.base.respond_to?(:columns_hash)
    end

    # Returns the association reflection for the method if it exists
    def reflection_for(method)
      @object.base.reflect_on_association(method) if @object && @object.base.respond_to?(:reflect_on_association)
    end
